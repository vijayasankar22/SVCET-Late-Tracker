...
export function Header() {
  ...
  return (
    <div className="sticky top-0 z-30 flex flex-col">
      <header className="flex h-16 items-center gap-4 border-b bg-primary px-4 text-primary-foreground shadow-md sm:px-6">
      ...
      <div className="bg-accent text-accent-foreground overflow-hidden whitespace-nowrap">
        <div className="animate-marquee inline-block py-2">
          <span className="font-semibold text-sm px-4">Wishing You all a Happy Diwali</span>
          <span className="font-semibold text-sm px-4">Wishing You all a Happy Diwali</span>
          <span className="font-semibold text-sm px-4">Wishing You all a Happy Diwali</span>
          <span className="font-semibold text-sm px-4">Wishing You all a Happy Diwali</span>
        </div>
